...
## Corpus Check
- 87 files · ~17,221 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 998 nodes · 1481 edges · 73 communities
...
2. `TransactionsCubit` - 23 edges
3. `DashboardCubit` - 14 edges
4. `LoginCubit` - 12 edges
5. `ItemsCubit` - 12 edges
6. `InventoryItem` - 9 edges
7. `MovementKind` - 7 edges
8. `CartonPieceQuantity` - 6 edges
9. `LoginState` - 6 edges
10. `DashboardState` - 6 edges

## Surprising Connections (you probably didn't know these)
- `initState` --references--> `ItemCatalogCubit`  [EXTRACTED]
  lib/features/returns/presentation/screens/warehouse_return_screen.dart → lib/features/items/cubit/item_catalog_cubit.dart
- `initState` --references--> `ItemCatalogCubit`  [EXTRACTED]
...
Cohesion: 0.18
Nodes (11): core/constants/app_strings.dart, ../../../../core/shared_widgets/custom_text_field.dart, ../../cubit/transactions_cubit.dart, ../../cubit/transactions_state.dart, build, TransactionHistoryScreen, build, _buildFilterChip (+3 more)
...
Cohesion: 0.10
Nodes (25): ../../../../core/constants/app_routes.dart, ../../cubit/dashboard_cubit.dart, ../../cubit/dashboard_state.dart, DashboardCubit, DashboardFailure, DashboardInitial, DashboardLoading, DashboardState (+17 more)
...
Cohesion: 0.22
Nodes (8): build, createState, initState, _UiOnlyNotice, build, AppRoutes.newMovement, ../widgets/return_workflow_card.dart, ../widgets/warehouse_return_form.dart
...
Cohesion: 0.13
Nodes (15): CustomTextField, build, description, isLast, number, ReturnWorkflowCard, title, _WorkflowStep (+7 more)

### Community 18 - "dashboard_repository.dart"
Cohesion: 0.17
Nodes (11): Key, build, buttonKey, color, icon, onStocktakeTap, onTap, onWarehouseReturnTap (+3 more)
...
Cohesion: 0.20
Nodes (9): ../../../../core/shared_widgets/pdf_voucher_dialog.dart, ../../../../core/shared_widgets/status_badge.dart, ../../data/models/transaction_model.dart, TransactionModel, build, _buildBadge, _showPdfDialog, transaction (+1 more)
...
Cohesion: 0.08
Nodes (24): ../../../items/cubit/item_catalog_state.dart, _changeMovementKind, createState, _itemCountLabel, _lines, _movementKind, onItemTap, onSearchChanged (+16 more)
...
Cohesion: 0.29
Nodes (7): ../../../../core/shared_widgets/custom_app_bar.dart, build, createState, InboundEntryScreen, _InboundEntryScreenState, initState, ../widgets/inbound_form.dart
...
Cohesion: 0.12
Nodes (16): ../../../../core/models/carton_piece_quantity.dart, int get, build, _cartons, createState, _exceedsAvailableStock, _hasQuantity, initialSelection (+8 more)

### Community 34 - "movement_ui_types.dart"
Cohesion: 0.11
Nodes (17): active, code, copyWith, currentStockBalance, currentStockPieces, fromMap, id, itemsPerCarton (+9 more)
...
Cohesion: 0.15
Nodes (12): ../../../../core/models/inventory_item.dart, dashboard_repository_base.dart, ../../../items/data/repositories/items_repository_base.dart, DashboardRepositoryBase, watchItems, DashboardRepository, _itemsRepository, watchItems (+4 more)

### Community 37 - "movement_type_selector.dart"
Cohesion: 0.18
Nodes (10): backgroundColor, build, color, icon, label, onChanged, onTap, selected (+2 more)

### Community 38 - "current_voucher_panel.dart"
Cohesion: 0.18
Nodes (10): build, CurrentVoucherPanel, _EmptyVoucherState, _itemCountLabel, line, lines, movementKind, onContinue (+2 more)
...
Cohesion: 0.18
Nodes (10): ../../../../core/constants/app_colors.dart, ../../../../core/constants/app_text_styles.dart, ../../data/models/stock_summary_model.dart, build, _buildItemCard, StockItemsList, build, _buildStatItem (+2 more)
...
Cohesion: 0.15
Nodes (12): core/di/service_locator.dart, core/theme/app_theme.dart, features/dashboard/cubit/dashboard_cubit.dart, features/items/cubit/item_catalog_cubit.dart, features/items/cubit/items_cubit.dart, features/transactions/cubit/transactions_cubit.dart, GoRouter, build (+4 more)
...
Cohesion: 0.33
Nodes (5): ../data/repositories/items_repository_base.dart, ../data/repositories/items_repository_failure.dart, items_state.dart, _repository, submitNewItem
...
Cohesion: 0.20
Nodes (10): ../../../../core/shared_widgets/carton_piece_quantity_fields.dart, ../../../items/presentation/widgets/inventory_item_selector_field.dart, _actualQuantity, AdjustmentForm, _AdjustmentFormState, createState, dispose, _isSubmitting (+2 more)
...
Cohesion: 0.11
Nodes (18): custom_text_field.dart, ../extensions/inventory_number_parsing.dart, build, CartonPieceQuantityFields, _CartonPieceQuantityFieldsState, _cartonsController, createState, dispose (+10 more)
...
Cohesion: 0.22
Nodes (8): ChangeNotifier, dart:async, ../../data/repositories/auth_repository.dart, AuthSessionNotifier, dispose, _subscription, package:flutter/foundation.dart, StreamSubscription

### Community 61 - "stock_summary_model.dart"
Cohesion: 0.12
Nodes (15): actionLabel, cartons, date, deliveredBy, driverName, item, label, notes (+7 more)

### Community 62 - "State"
Cohesion: 0.40
Nodes (6): WarehouseReturnScreen, _WarehouseReturnScreenState, NewMovementScreen, _NewMovementScreenState, State, StatefulWidget
...
### Community 67 - "outbound_entry_screen.dart"
Cohesion: 0.29
...
### Community 68 - "stock_adjustment_screen.dart"
Cohesion: 0.33
Nodes (6): createState, initState, StockAdjustmentScreen, _StockAdjustmentScreenState, package:go_router/go_router.dart, ../widgets/adjustment_form.dart

### Community 69 - "item_catalog_cubit.dart"
Cohesion: 0.33
Nodes (5): item_catalog_state.dart, close, loadItems, _repository, _subscription

### Community 70 - "../../../../core/constants/app_sizes.dart"
Cohesion: 0.40
Nodes (4): ../../../../core/constants/app_sizes.dart, AddItemScreen, build, ../widgets/add_item_form.dart

### Community 71 - "CartonPieceQuantity"
Cohesion: 0.40
Nodes (4): CartonPieceQuantity, cartons, pieces, totalPiecesFor

### Community 72 - "inventory_number_parsing.dart"
Cohesion: 0.50
Nodes (3): InventoryNumberParsing, toInventoryInteger, String?

## Knowledge Gaps
- **597 isolated node(s):** `AppColors`, `primary`, `primaryLight`, `primaryDark`, `secondary` (+592 more)
...
- **Why does `InventoryItem` connect `selectable_item_card.dart` to `inventory_item_selector_field.dart`, `movement_ui_types.dart`, `item_quantity_sheet.dart`, `add_item_form.dart`, `inbound_form.dart`, `outbound_form.dart`, `adjustment_form.dart`, `stock_summary_model.dart`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `TransactionsCubit` connect `transactions_state.dart` to `ItemCatalogCubit`, `TransactionsCubit`, `transactions_cubit.dart`, `package:flutter_bloc/flutter_bloc.dart`, `login_screen.dart`, `inbound_form.dart`, `outbound_form.dart`, `transaction_list_item.dart`, `adjustment_form.dart`?**
