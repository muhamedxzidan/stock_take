...
## Corpus Check
- 135 files · ~30,917 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1660 nodes · 2335 edges · 113 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3599e4f5`
...
1. `ReturnResolutionCubit` - 17 edges
2. `ItemCatalogCubit` - 16 edges
3. `PrinterCubit` - 16 edges
4. `MovementHistoryCubit` - 16 edges
5. `StocktakeCubit` - 15 edges
6. `DashboardCubit` - 14 edges
7. `LoginCubit` - 11 edges
8. `ItemsCubit` - 11 edges
9. `ReturnsCubit` - 11 edges
10. `TransactionsCubit` - 11 edges
...
- `_DashboardScreenState` --references--> `DashboardCubit`  [EXTRACTED]
...
Cohesion: 0.11
Nodes (20): ../../cubit/printer_cubit.dart, ../../cubit/printer_state.dart, ThermalReceiptData, ThermalReceiptRasterizer, build, PrinterSetupButton, build, _controller (+12 more)
...
Cohesion: 0.27
Nodes (10): CartonPieceQuantityFields, _CartonPieceQuantityFieldsState, DashboardScreen, _DashboardScreenState, _InventoryItemPickerSheet, _InventoryItemPickerSheetState, StartStocktakeCard, _StartStocktakeCardState (+2 more)
...
Cohesion: 0.10
Nodes (24): PrinterCubit, PrinterState, build, createState, _cubit, didChangeDependencies, dispose, _emptyMessage (+16 more)
...
Cohesion: 0.06
Nodes (42): Cubit, build, ItemCatalogCubit, ItemCatalogFailure, ItemCatalogInitial, ItemCatalogLoading, ItemCatalogState, ItemCatalogSuccess (+34 more)
...
Cohesion: 0.15
Nodes (12): Color, ../constants/app_colors.dart, adjustment, backgroundColor, build, inbound, label, outbound (+4 more)
...
Cohesion: 0.05
Nodes (37): AuthRepository, AuthSessionNotifier, ../constants/app_router.dart, DashboardCubit, DashboardRepositoryBase, ../../features/auth/data/repositories/firebase_auth_repository.dart, ../../features/dashboard/data/repositories/dashboard_repository_base.dart, ../../features/dashboard/data/repositories/dashboard_repository.dart (+29 more)
...
Cohesion: 0.18
Nodes (15): ../../data/models/stock_summary_model.dart, DashboardCubit, allItems, DashboardFailure, DashboardInitial, DashboardLoading, DashboardState, DashboardSuccess (+7 more)
...
Cohesion: 0.04
Nodes (44): carton_piece_quantity.dart, ../extensions/inventory_number_parsing.dart, int get, active, code, copyWith, currentStockBalance, currentStockPieces (+36 more)
...
Cohesion: 0.39
Nodes (9): AppRouter, StocktakeCubit, StocktakeActionInProgress, StocktakeCancelled, StocktakeCompleted, StocktakeFailure, StocktakeLoading, StocktakeReady (+1 more)
...
Cohesion: 0.15
Nodes (12): dart:typed_data, connect, connectionProfile, discoverPrinters, loadSelectedPrinter, PrinterRepositoryBase, printReceiptPng, saveSelectedPrinter (+4 more)
...
Cohesion: 0.15
Nodes (13): ../../../../core/shared_widgets/carton_piece_quantity_fields.dart, ../../../../core/shared_widgets/custom_button.dart, ../../cubit/items_cubit.dart, ../../cubit/items_state.dart, AddItemForm, _AddItemFormState, build, createState (+5 more)
...
Cohesion: 0.13
Nodes (14): ../../data/mappers/movement_receipt_mapper.dart, MovementRecord, build, _DetailText, _formatDate, _itemsLabel, label, movement (+6 more)
...
Cohesion: 0.18
Nodes (10): ../constants/app_strings.dart, GoRouterState, build, child, _confirmLogout, MainShellScreen, state, ../responsive/responsive_layout.dart (+2 more)
...
Cohesion: 0.25
Nodes (7): ChangeNotifier, dart:async, ../../data/repositories/auth_repository.dart, AuthSessionNotifier, dispose, _subscription, package:flutter/foundation.dart
...
### Community 97 - "List"
Cohesion: 0.17
Nodes (10): InventoryNumberParsing, toInventoryInteger, availability, devices, message, PrinterDiscoveryAvailability, PrinterDiscoverySnapshot, List (+2 more)

### Community 98 - "bluetooth_printer_repository.dart"
Cohesion: 0.09
Nodes (21): connect, discoverPrinters, loadSelectedPrinter, _preferencesChannel, _printImage, _printImageWithBluetooth, printReceiptPng, _printSlice (+13 more)

### Community 99 - "thermal_receipt_content.dart"
Cohesion: 0.12
Nodes (19): build, index, label, line, receipt, _ReceiptDetail, _ReceiptDivider, _ReceiptItem (+11 more)

### Community 100 - "dashboard_screen.dart"
Cohesion: 0.12
Nodes (18): ../../../../core/constants/app_sizes.dart, core/constants/app_strings.dart, ../../../../core/shared_widgets/custom_app_bar.dart, ../../../../core/shared_widgets/custom_text_field.dart, ../../cubit/dashboard_cubit.dart, ../../cubit/dashboard_state.dart, ../../data/mappers/stock_balance_receipt_mapper.dart, createState (+10 more)
...
Cohesion: 0.67
Nodes (3): BluetoothPrinterRepository, PrinterDiscoverySnapshot, PrinterRepositoryBase
...
## Knowledge Gaps
- **1003 isolated node(s):** `Answer`, `Outcome`, `Source Nodes`, `serviceLocator`, `reset` (+998 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Work-memory lessons

**Preferred sources** — corroborated by past sessions; start here.
- `LoginCubit` (5× useful, score=4.562414981)
- `FirebaseAuthRepository` (5× useful, score=4.562414981)
- `NewMovementScreen` (5× useful, score=4.52208172)
- `TransactionsCubit` (5× useful, score=4.449203822)
- `AuthSessionNotifier` (4× useful, score=3.650685919)
- `PrinterCubit` (3× useful, score=2.890075716)
- `ThermalReceiptDialog` (3× useful, score=2.890075716)
- `ThermalReceiptContent` (3× useful, score=2.887921638)
- `WarehouseReturnForm` (3× useful, score=2.747186191)
- `TransactionsRepository` (3× useful, score=2.733172129)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `ReturnsCubit` connect `warehouse_return_draft.dart` to `transaction_list_item.dart`, `stock_summary_card.dart`, `main.dart`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `InventoryItem` connect `warehouse_return_screen.dart` to `inventory_item_selector_field.dart`, `ItemsCubit`, `movement_voucher_preview_dialog.dart`, `warehouse_return_draft.dart`, `tablet_navigation_rail.dart`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `LoginCubit` connect `item_model.dart` to `transaction_list_item.dart`, `../../../dashboard/data/models/item_model.dart`, `../constants/app_colors.dart`, `transaction_filter_bar.dart`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
