...
## Corpus Check
- 143 files · ~31,208 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1674 nodes · 2391 edges · 112 communities
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4c222a68`
...
- `_confirmCancellation` --references--> `StocktakeCubit`  [EXTRACTED]
  lib/features/stocktake/presentation/screens/stocktake_screen.dart → lib/features/stocktake/cubit/stocktake_cubit.dart
...
- `DashboardCubit` --calls--> `DashboardFailure`  [EXTRACTED]
  lib/features/dashboard/cubit/dashboard_cubit.dart → lib/features/dashboard/cubit/dashboard_state.dart
...
Cohesion: 0.07
Nodes (30): DocumentReference, createCustomerReturn, resolveReturn, ReturnsRepositoryBase, watchPendingReturns, _counters, createCustomerReturn, _customerReturnCounterId (+22 more)
...
Cohesion: 0.07
Nodes (36): ../../cubit/printer_cubit.dart, ../../cubit/printer_state.dart, ThermalReceiptData, PrinterCubit, PrinterState, build, createState, _cubit (+28 more)
...
Cohesion: 0.27
Nodes (10): CartonPieceQuantityFields, _CartonPieceQuantityFieldsState, _ReturnResolutionDialog, _ReturnResolutionDialogState, ItemQuantitySheet, _ItemQuantitySheetState, MovementDetailsSheet, _MovementDetailsSheetState (+2 more)
...
Cohesion: 0.17
Nodes (19): AppRouter, StocktakeCubit, action, completion, itemId, lines, message, session (+11 more)

### Community 13 - "pdf_voucher_dialog.dart"
Cohesion: 0.15
Nodes (12): ../../../../core/shared_widgets/custom_app_bar.dart, ../../cubit/stocktake_cubit.dart, ../../cubit/stocktake_state.dart, build, build, _confirmCancellation, message, _StocktakeLoadFailure (+4 more)
...
Cohesion: 0.13
Nodes (14): adjustedItemCount, cancelledAt, completedAt, id, movementVoucherNumber, netDifferencePieces, notes, periodFrom (+6 more)
...
Cohesion: 0.14
Nodes (13): build, _continue, createState, _dateController, _deliveredByController, dispose, _driverController, initState (+5 more)
...
Cohesion: 0.07
Nodes (28): _adjustmentCounterId, cancelStocktake, _claimLegacyOpenSession, completeStocktake, _counters, fetchOpenStocktake, _firebaseAuth, _firestore (+20 more)

### Community 24 - "transaction_list_item.dart"
Cohesion: 0.05
Nodes (49): ../../../../core/constants/app_routes.dart, ../../cubit/return_resolution_cubit.dart, ../../../items/cubit/item_catalog_cubit.dart, build, ItemCatalogCubit, ItemCatalogFailure, ItemCatalogInitial, ItemCatalogLoading (+41 more)
...
Cohesion: 0.18
Nodes (11): _actualQuantity, build, createState, initState, isSaving, line, quantity, sign (+3 more)

### Community 29 - "transactions_state.dart"
Cohesion: 0.17
Nodes (10): fromMap, _statusFrom, WarehouseReturnFirestoreMapper, read, StocktakeFirestoreFailureMapper, write, ../models/warehouse_return_record.dart, package:cloud_firestore/cloud_firestore.dart (+2 more)
...
Cohesion: 0.17
Nodes (11): ../../../../core/shared_widgets/custom_button.dart, ../../data/models/stocktake_line.dart, build, isCancelling, isCompleting, lines, savingItemId, session (+3 more)

### Community 35 - "items_cubit.dart"
Cohesion: 0.20
Nodes (13): ../../data/mappers/stock_balance_receipt_mapper.dart, DashboardCubit, build, createState, DashboardScreen, _DashboardScreenState, initState, _printStockBalance (+5 more)
...
Cohesion: 0.08
Nodes (29): carton_piece_quantity.dart, Cubit, active, code, copyWith, currentStockBalance, currentStockPieces, fromMap (+21 more)
...
Cohesion: 0.31
Nodes (10): TransactionsCubit, InventoryMovementFailure, InventoryMovementSaved, InventoryMovementSaving, message, movement, TransactionsInitial, TransactionsState (+2 more)
...
Cohesion: 0.29
Nodes (9): allItems, DashboardFailure, DashboardInitial, DashboardLoading, DashboardState, DashboardSuccess, items, message (+1 more)

### Community 46 - "item_model.dart"
Cohesion: 0.06
Nodes (35): bool get, ../../cubit/login/login_cubit.dart, ../../cubit/login/login_state.dart, ../../data/repositories/auth_failure.dart, ../../data/repositories/auth_repository.dart, FormState, _authRepository, _isValidEmail (+27 more)
...
Cohesion: 0.05
Nodes (42): int get, cartons, date, deliveredBy, documentTitle, driverName, itemCode, itemName (+34 more)
...
Cohesion: 0.22
Nodes (8): StocktakeSession, build, countedItems, _formatDate, netDifference, session, StocktakeSessionHeader, totalItems
...
Cohesion: 0.31
Nodes (9): MovementHistoryCubit, MovementHistoryFailure, MovementHistoryLoading, MovementHistoryState, MovementHistorySuccess, build, _DateFilterBar, initState (+1 more)
...
Cohesion: 0.15
Nodes (13): ../../../../core/shared_widgets/carton_piece_quantity_fields.dart, ../../../../core/shared_widgets/custom_text_field.dart, ../../cubit/items_cubit.dart, ../../cubit/items_state.dart, AddItemForm, _AddItemFormState, build, createState (+5 more)
...
Cohesion: 0.29
Nodes (6): core/constants/app_strings.dart, ../../cubit/dashboard_cubit.dart, ../../cubit/dashboard_state.dart, build, _buildItemCard, StockItemsList

### Community 75 - "LoginCubit"
Cohesion: 0.12
Nodes (15): ../../data/mappers/movement_receipt_mapper.dart, MovementRecord, build, _DetailText, _formatDate, _itemsLabel, label, movement (+7 more)
...
Cohesion: 0.06
Nodes (38): ../../cubit/returns_cubit.dart, ../../cubit/returns_state.dart, ../../data/models/warehouse_return_draft.dart, ../data/repositories/returns_repository_base.dart, ../data/repositories/returns_repository_failure.dart, ../../../items/presentation/widgets/inventory_item_selector_field.dart, createCustomerReturn, _isSaving (+30 more)
...
Cohesion: 0.40
Nodes (4): ../../data/models/stocktake_session.dart, StocktakeDraftValidator, validate, _
...
### Community 93 - "String?"
Cohesion: 0.25
Nodes (7): ../../data/models/printer_discovery_snapshot.dart, ../data/repositories/printer_repository_base.dart, PrinterDiscoveryController, _repository, start, stop, _subscription
...
### Community 97 - "List"
Cohesion: 0.20
Nodes (9): availability, devices, message, PrinterDiscoveryAvailability, PrinterDiscoverySnapshot, BluetoothPrinterRepository, PrinterRepositoryBase, List (+1 more)
...
Cohesion: 0.14
Nodes (17): build, index, label, line, receipt, _ReceiptDetail, _ReceiptDivider, _ReceiptItem (+9 more)

### Community 100 - "dashboard_screen.dart"
Cohesion: 0.18
Nodes (9): ../../../../core/constants/app_sizes.dart, ../../../../core/constants/app_text_styles.dart, build, _buildStatItem, StockSummaryCard, summary, AddItemScreen, build (+1 more)
...
## Knowledge Gaps
- **1017 isolated node(s):** `AppColors`, `primary`, `primaryLight`, `primaryDark`, `secondary` (+1012 more)
...
- `StockAdjustmentScreen` (3× useful, score=2.704547556) _(code changed — re-verify)_
- `AppRouter` (3× useful, score=2.702146164) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `MovementHistoryCubit` connect `ItemsCubit` to `../../../../core/models/inventory_item.dart`, `movement_voucher_preview_dialog.dart`, `TransactionsCubit`, `main.dart`, `transaction_history_screen.dart`, `../../../../core/constants/app_colors.dart`, `TransactionsCubit`?**
...
- **Why does `MovementReportSummary` connect `movement_report_summary.dart` to `transaction_history_screen.dart`, `TransactionsCubit`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `PrinterCubit` connect `main.dart` to `movement_voucher_preview_dialog.dart`, `TransactionsCubit`, `main.dart`, `TransactionsCubit`, `item_catalog_cubit.dart`?**
