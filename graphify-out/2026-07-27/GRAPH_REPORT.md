...
## Corpus Check
- 51 files · ~8,807 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 573 nodes · 801 edges · 32 communities
...
- `_AddItemFormState` --references--> `ItemsCubit`  [EXTRACTED]
  lib/features/items/presentation/widgets/add_item_form.dart → lib/features/items/cubit/items_cubit.dart
- `build` --references--> `ItemsCubit`  [EXTRACTED]
  lib/features/items/presentation/widgets/add_item_form.dart → lib/features/items/cubit/items_cubit.dart
...
Cohesion: 0.03
Nodes (57): actualCount, addItemTitle, adjustmentReason, adjustmentTitle, AppStrings, appTitle, cancel, cartonCount (+49 more)

### Community 1 - "StatelessWidget"
Cohesion: 0.07
Nodes (33): ../../../../core/constants/app_sizes.dart, core/constants/app_strings.dart, ../../../../core/shared_widgets/custom_app_bar.dart, CustomAppBar, CustomTextField, AddItemScreen, build, build (+25 more)
...
Cohesion: 0.18
Nodes (10): ../../../../core/shared_widgets/custom_text_field.dart, ../../cubit/transactions_cubit.dart, ../../cubit/transactions_state.dart, build, TransactionHistoryScreen, build, _buildFilterChip, TransactionFilterBar (+2 more)
...
Cohesion: 0.14
Nodes (13): app_colors.dart, AppTextStyles, bodyLarge, bodyMedium, bodySmall, buttonText, caption, heading1 (+5 more)
...
Cohesion: 0.05
Nodes (40): ../../../../core/shared_widgets/custom_button.dart, ../../cubit/items_cubit.dart, ../../cubit/items_state.dart, ../../data/models/warehouse_return_draft.dart, AddItemForm, _AddItemFormState, build, _codeController (+32 more)

### Community 8 - "DashboardCubit"
Cohesion: 0.09
Nodes (30): core/constants/app_router.dart, core/theme/app_theme.dart, Cubit, features/dashboard/cubit/dashboard_cubit.dart, features/dashboard/data/repositories/dashboard_repository.dart, features/items/cubit/items_cubit.dart, features/items/data/repositories/items_repository.dart, features/transactions/cubit/transactions_cubit.dart (+22 more)

### Community 9 - "transaction_model.dart"
Cohesion: 0.07
Nodes (25): ../../../../core/shared_widgets/pdf_voucher_dialog.dart, ../../../../core/shared_widgets/status_badge.dart, ../../data/models/transaction_model.dart, actorName, date, fromJson, id, itemCode (+17 more)
...
Cohesion: 0.16
Nodes (11): ../../../dashboard/data/models/item_model.dart, ../data/repositories/items_repository_base.dart, items_repository_base.dart, items_state.dart, _repository, submitNewItem, addItem, addItem (+3 more)

### Community 13 - "pdf_voucher_dialog.dart"
Cohesion: 0.14
Nodes (13): ../constants/app_strings.dart, build, _buildRow, date, deliveredBy, itemName, partyName, PdfVoucherDialog (+5 more)

### Community 14 - "adjustment_form.dart"
Cohesion: 0.22
Nodes (9): _actualCountController, AdjustmentForm, _AdjustmentFormState, createState, dispose, _itemCodeController, _itemNameController, _reasonController (+1 more)

### Community 15 - "inbound_form.dart"
Cohesion: 0.17
Nodes (12): createState, _dateController, _deliveredByController, dispose, InboundForm, _InboundFormState, _itemCodeController, _itemNameController (+4 more)

### Community 16 - "outbound_form.dart"
Cohesion: 0.17
Nodes (12): createState, _dateController, _dispatchedByController, dispose, _itemCodeController, _itemNameController, OutboundForm, _OutboundFormState (+4 more)

### Community 17 - "stock_summary_card.dart"
Cohesion: 0.06
Nodes (31): ../../../../core/constants/app_colors.dart, ../../../../core/constants/app_routes.dart, ../../../../core/constants/app_text_styles.dart, ../../cubit/dashboard_cubit.dart, ../../cubit/dashboard_state.dart, ../../data/models/item_model.dart, ../../data/models/stock_summary_model.dart, fromJson (+23 more)
...
Cohesion: 0.20
Nodes (9): IconData, backgroundColor, build, CustomButton, icon, isLoading, onPressed, text (+1 more)
...
Cohesion: 0.29
Nodes (6): ../constants/app_text_styles.dart, actions, build, preferredSize, title, Size get

### Community 28 - "package:flutter/material.dart"
Cohesion: 0.50
Nodes (3): ../constants/app_colors.dart, AppTheme, package:flutter/material.dart

### Community 29 - "transactions_state.dart"
Cohesion: 0.33
Nodes (8): message, selectedFilter, transactions, TransactionsFailure, TransactionsInitial, TransactionsLoading, TransactionsState, TransactionsSuccess

### Community 30 - "TransactionsCubit"
Cohesion: 0.47
Nodes (6): build, TransactionsCubit, build, build, build, AppRoutes.transactionHistory
...
## Knowledge Gaps
- **350 isolated node(s):** `AppColors`, `primary`, `primaryLight`, `primaryDark`, `secondary` (+345 more)
  These have ≤1 connection - possible missing edges or undocumented components.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `TransactionsCubit` connect `TransactionsCubit` to `TransactionsCubit`, `DashboardCubit`, `transactions_cubit.dart`, `adjustment_form.dart`, `inbound_form.dart`, `outbound_form.dart`, `transactions_state.dart`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `ReturnItemCondition` connect `transaction_list_item.dart` to `add_item_form.dart`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `ItemsCubit` connect `DashboardCubit` to `package:flutter_bloc/flutter_bloc.dart`, `add_item_form.dart`?**
